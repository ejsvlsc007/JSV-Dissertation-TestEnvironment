...
# ===========================================================================
# Deep-Supervision Loss  (Dice + BCE, geometrically weighted)
# ===========================================================================
...
class DeepSupervisionLoss(nn.Module):
    ...
    Works identically in MCT and MCT_FUSION modes -- the mask is always
    a single-channel binary (1, H, W) tensor regardless of input channels.
    """
