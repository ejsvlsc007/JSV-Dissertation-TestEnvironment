"""
models/D3_2_effnetb4_cswin.py
==============================
D3.2 — EfficientNet-B4 (pretrained) + CSwin Transformer (from scratch)
"""
...
def build_model(in_channels=3, img_size=256, **cfg) -> nn.Module:
    return D3_2(in_channels=in_channels, img_size=img_size, **cfg)
